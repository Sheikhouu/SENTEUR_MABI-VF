  ...
  const articles = [
    {
      ...
      excerpt: "Découvrez l'art ancestral du Thiouraye, l'encens traditionnel sénégalais aux vertus purifiantes et relaxantes. Une exploration des rituels et traditions qui font la richesse de notre patrimoine olfactif.",
      readTime: '8 min',
      category: 'Tradition',
    ...
    {
      id: 'huiles-parfumees',
      title: "Trois Façons Sublimes d'Utiliser Nos Huiles pour le Corps",
      excerpt: 'Explorez les secrets millénaires des huiles parfumées, véritables élixirs de beauté qui nourrissent la peau et éveillent les sens. Une tradition de bien-être transmise à travers les générations.',
      readTime: '6 min',
      category: 'Bien-être',
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Découvrez les secrets ancestraux des senteurs traditionnelles . Une invitation au voyage des sens et à la découverte de pratiques millénaires.
          </p>
        </motion.div>
