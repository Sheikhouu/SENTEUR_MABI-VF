export const productData = {
  ...
  ambientFragrances: {
    products: [
      {
        id: 'huile-bruler-1',
        name: 'Huile à Brûler Traditionnelle',
        description:
          "Une huile parfumée traditionnelle pour créer une atmosphère envoûtante dans votre intérieur. Ses notes orientales et boisées transforment instantanément l'ambiance de votre maison.",
        prices: {
          eur: 14,
          cad: 20,
          fcfa: 5000,
        ...
        volume_ml: 50,
        notes: ['Notes Orientales', 'Bois Précieux'],
    ...
    articles: [
      {
        ...
        excerpt:
          'Découvrez l\'art ancestral du Thiouraye, l\'encens traditionnel sénégalais aux vertus purifiantes et relaxantes. Une exploration des rituels et traditions qui font la richesse de notre patrimoine olfactif.',
        image:
      ...
      },
      {
        ...
        excerpt:
          "Explorez les rituels de beauté transmis de génération en génération pour une expérience unique qui nourrit le corps et l'âme.",
        image:
