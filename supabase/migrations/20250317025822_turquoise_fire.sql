/*
  # Fix Cloudinary Image URLs with Version Numbers

  1. Changes
    - Update image URLs to use correct Cloudinary paths with version numbers
    - Add proper URL structure for Cloudinary assets
*/
